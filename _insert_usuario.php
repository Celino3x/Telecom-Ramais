<?php
    ...
    $sql = "INSERT INTO `usuarios`(`nome_usuario`, `mail_usuario`, `senha_usuario`, `nivel_usuario`, `status_usuario`) VALUES ('$nome_usuario','$mail_usuario',sha1('$senha_usuario'),$nivel_usuario,'$status')";
