...
<html lang="pt-br">
  <head>
    <meta charset="utf-8">
    <title>Cadastro Sucesso!| Telecom</title>
  ...
  <body>
    <div class="container voltar">
        <center>
            <h3>Ramal adicionado com sucesso!</h3>
            <div class="voltar-btn">
                <a href="cadastrar_ramal.php" role="button" class="btn btn-secondary"><i class="fas fa-undo-alt"></i> Cadastrar Novo Ramal</a>
            </div>
        </center>
    </div>
