...
<html lang="pt-br">
  <head>
    <meta charset="utf-8">
    <title>Adicionar Setor | Telecom</title>
  ...
  <div class="container formSetor">
    ...
    <form action="_inserir_setor.php" method="post">
        <label>Nome do Setor</label>
        <div class="form-group">
            <input type="text" name="setor" class="form-control" placeholder="Digite o nome do setor" autocomplete="off">
        </div>
